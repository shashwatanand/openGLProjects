...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.shashwat.opengl.firstdemo"; //$NON-NLS-1$
	...
	private static final String ssCommandCategoryID = "OpenGL.commands.category";
	private static final String ssCommandCategoryName = "OpenGL Demo commands";
	 ...
	 *
	 * @param sIconPath
	 *            Path to the icon file inside the "icons" directory of the
	 *            plugin project.
